...
var Config = IniFile{
	...
	// default theme: matrix-style green-on-black terminal (CRT hacker look)
	&Colors{
		Background:      "black",
		Text:            "lime",
		ForwardedText:   "mediumspringgreen",
		ListHeader:      "lime",
		ListContact:     "palegreen",
		ListGroup:       "springgreen",
		ChatContact:     "lightgreen",
		ChatMe:          "lime",
		Borders:         "green",
